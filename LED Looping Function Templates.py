'''LED Looping Function Templates'''


# This is a complete template set of Robomaster S1's
# LED's that you can use in your next Robomaster S1
# Python programming projects. Each LED function
# template contains while-loops, for-loops and some
# with 'nested' for-loops.

# Also, each LED function template is stored inside a
# Python dictionary array, which also illustrates the use
# of the '.get(n)' function attribute. You can create tuple(n)
# arrays, list(n) arrays as well as dictionary{n:value}
...
# Store all 33 function callers inside a dictionary called
# funcs_dict{...} Note: do not invoke the function's
# parantheses () inside the dictonary values. If you do,
# the function will be executed right away, which is

...
# Robomaster S1 RGB Looping Templates class variables version examples:
...
def start():
    ...
    # each of these class veriables: a through m, create different RGB looping effects

    classes=(
        a.rgb1, #index[0]  RGB_single_colour_spin_forward
        b.rgb1, #index[1]  RGB_single_colour_spin_reverse
        c.rgb1, #index[2]  RGB_double_colour_spin_forward
        d.rgb1, #index[3]  RGB_double_colour_spin_forward
        e.rgb1, #index[4]  RGB_quad_colour_rotate_forward_reverse
        f.rgb1, #index[5]  RGB_flash_colour_changers_and_smooth_shift_colour_change_contrast
        g.rgb1, #index[6]  RGB_flash_flip_colour_changer
        h.rgb1, #index[7]  RGB_colour_flipper
        i.rgb1, #index[8]  RGB_colour_trail_blazer_forward_reverse
        j.rgb1, #index[9]  RGB_colour_dimmer
        k.rgb1, #index[10] RGB_single_colour_spin_forward_reverse_random
    ...
    try:
        classes[0]() # choose your RGB template classes index[n] value
    except:
        print('clases tuple name and/or index[n] value not found:')
        classes[0]() # classes tuple name and index[n] value defaults back to classes[0]
